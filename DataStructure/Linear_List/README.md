...
![单向链表](/Users/junping/Programming/UNGEE/DataStructure/Linear_List/assets/image-20180902190513192.png)
...
![image-20180902213733749](/Users/junping/Programming/UNGEE/DataStructure/Linear_List/assets/image-20180902213733749.png)
...
![image-20180902223858978](/Users/junping/Programming/UNGEE/DataStructure/Linear_List/assets/image-20180902223858978.png)
...
【例题9】已知一个整数序列A=(a<sub>0</sub>, a<sub>1</sub>, ..., a<sub>n-1</sub>)，其中0 <= a<sub>i</sub> < n (0 <= i < n)。若存在a<sub>p1</sub> = a<sub>p2</sub> = ... = a<sub>pm</sub> = x<br>且m > n/2 (0 <= p<sub>k</sub> < n, 1 <= k <= m)，则称x为A的主元素。例如A = (0 , 5, 5, 3, 5, 7, 5, 5)，则5为主元素；又如<br>A = (0, 5, 5, 3, 5, 1, 5, 7) ，则A中没有主元素。假设A中的n个元素保存在一个一维数组中，请设计一个尽可能高效的算法，找出A的主元素。若存在主元素，则输出该元素；否则输出-1。要求：
